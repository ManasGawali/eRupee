...
function AuthUI() {
  ...
  const handleSendOTP = async () => {
    try {
      let url, body;
      if (activeTab === 'login') {
        url = 'https://erupee.onrender.com/user/login-step1';
        body = {
          user_name: formData.username,
          email: formData.email,
        };
      } else {
        url = 'https://erupee.onrender.com/user/register-step1';
        body = {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      let url, body;
      if (activeTab === 'login') {
        url = 'https://erupee.onrender.com/user/login-step2';
        body = {
          user_name: formData.username,
          email: formData.email,
          otp: formData.otp,
        ...
        url = 'https://erupee.onrender.com/user/register-step2';
        body = {
          name: formData.fullName,
          user_name: formData.username,
          email: formData.email,
